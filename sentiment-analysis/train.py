...
from data import MyClassificationDataset, create_dataloader, DATA_PATH
...
if __name__ == '__main__':
    # 加载数据集
    train_dataset = MyClassificationDataset(pathlib.Path(DATA_PATH) / 'train')
    # 数据集打乱后切片只使用前x条数据
    ...
    # 测试模型（假设有测试数据集）
    test_dataset = MyClassificationDataset(pathlib.Path(DATA_PATH) / 'test')
    # 测试数据集切片只使用前x条数据
